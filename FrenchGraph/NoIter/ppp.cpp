...
T VertexID;
      ...
      SmartVertex() { }
virtual bool AddVertex(const std::pair< T, size_t >&) { return 0; }
virtual bool DeleteVertex(const T&) { return 0; }
virtual ~SmartVertex() { }
virtual std::pair<const std::pair< T, size_t >*, const std::pair< T, size_t >* > AllConnectedVertex() const = 0;
...
std::pair<const Edge*, const Edge* > AllConnectedVertex() const {
...
std::pair< const std::pair< T, size_t >*, const std::pair< T, size_t >* > AllConnectedVertex() const {
...
std::pair<const std::pair< IdType, size_t >*,const std::pair< IdType, size_t >* > ConVertexlist = SmartVertexList[index]->AllConnectedVertex();

for (const std::pair< size_t, size_t >* ptr = ConVertexlist.first; ptr != ConVertexlist.second; ptr++) {
